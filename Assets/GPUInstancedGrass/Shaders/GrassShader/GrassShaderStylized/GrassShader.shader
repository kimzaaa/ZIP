Shader "Custom/GrassShaderInstancedWithShadowsAndSwayAndClouds"
{
    Properties
    {
        ...
        _Color3 ("Base Color", Color) = (0.6, 0.6, 0.6, 1)        
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 _MainTex_ST;
            float _Cutoff;
            float4 _Color3, _Color4, _ShadowColor;
            float _Height2, _Height3;
            ...
            Varyings vert(Attributes input)
            {
                ...
                float3 basePositionWS = mul(UNITY_MATRIX_M, float4(0, 0, 0, 1.0)).xyz;
                output.bladeHeight = basePositionWS.y; 
            ...
            half4 frag(Varyings input) : SV_TARGET
            {
                ...
                half4 baseColor = (input.bladeHeight > _Height3) ? _Color4 : _Color3;

                Light mainLight = GetMainLight(input.shadowCoord);
                float shadowAtten = mainLight.shadowAttenuation;
                half4 finalBase = (shadowAtten < _ShadowThreshold) ? _ShadowColor : baseColor;
                ...
                float cloudIntensity = (input.bladeHeight > _Height2) ? 1.0 : _CloudIntensity;
